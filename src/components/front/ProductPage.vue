        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-4 col-md-10 col-sm-10  mb-4">
                <div class="card text-center border shadow card-translateY">
                    ...
                    <div class="card-body">
                        <h2 class="card-title fs-2 fw-bolder">淺烘焙-Light</h2>
                        <p class="card-text">淺烘焙常見於單一產地咖啡豆烘焙，此種烘焙舊稱為肉桂烘焙</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-10 col-sm-10 mb-4">
                <div class="card text-center shadow card-translateY">
                    <img src="https://images.pexels.com/photos/942768/pexels-photo-942768.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                        class="card-img-top" alt="">
                    <div class="card-body">
                        <h2 class="card-title fs-2 fw-bolder"> 中烘焙-Medium</h2>
                        <p class="card-text">咖啡豆表面尚未出油，兼具巧克力般的苦味與醇厚風味</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4  col-md-10 col-sm-10 mb-4">
                <div class="card text-center shadow card-translateY">
                    <img src="@/assets/images/coffee3.jpg"
                        class="card-img-top" alt="">
                    <div class="card-body">
                        <h2 class="card-title fs-2 fw-bolder">深烘焙-Dark</h2>
                        <p class="card-text fs-6">咖啡豆呈現深黑色，並泛出油光，帶有苦巧克力的色澤。</p>
                    </div>
                </div>
            </div>
        </div>
